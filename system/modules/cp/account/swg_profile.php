...
<element1 attribute='ddbusers_deleted' value='0' type='string' />
		...
		elseif ($direct_classes['kernel']->v_user_check ("",$direct_cachedata['i_cusername'],true)) { $direct_classes['error_functions']->error_page ("standard","account_username_exists","SERVICE ERROR:<br />&quot;$direct_cachedata[i_cusername]&quot; has already been registered<br />sWG/#echo(__FILEPATH__)# _a=form-save_ (#echo(__LINE__)#)"); }
